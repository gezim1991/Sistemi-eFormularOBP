...
<!-- Modal -->
<div
  class="modal fade api-modal"
  id="{{ section_key }}_{{ link_key|slugify }}_modal"
  tabindex="-1"
  role="dialog"
  aria-labelledby="api explorer modal"
>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <div class="toggle-view hide">
          <div class="btn-group" role="group">
            <button type="button" data-display-toggle="data" class="btn btn-sm btn-info">
              Data
            </button>
        ...
        <h3 class="modal-title">
          <i class="fa fa-exchange"></i> {{ link.title|default:link_key }}
        </h3>
      </div>
      ...
      <form data-key='["{{ section_key }}", "{{ link_key }}"]' class="api-interaction">
        <div class="modal-body">
          <div class="row">
            <div class="col-lg-6 request">{% form_for_link link %}</div>
            ...
            <div class="col-lg-6 response" id="response">
              ...
              <pre
                class="well response-raw hide"
              ><div class="response-raw-request"></div><div class="response-raw-response"></div></pre>
            </div>
          </div>
        </div>
