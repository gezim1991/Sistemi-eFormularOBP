...
<!-- Modal -->
<div
  class="modal fade auth-modal auth-token"
  id="auth_token_modal"
  tabindex="-1"
  role="dialog"
  aria-labelledby="token authentication modal"
>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input
                ...
                id="scheme"
                placeholder="Bearer"
                aria-describedby="schemeHelpBlock"
                required
              />
              <span id="schemeHelpBlock" class="help-block"
                >Either a registered authentication scheme such as <code>Bearer</code>, or a custom
                schema such as <code>Token</code> or <code>JWT</code>.</span
              >
            </div>
          </div>
          <div class="form-group">
